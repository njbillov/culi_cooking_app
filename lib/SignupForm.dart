                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: FractionallySizedBox(
                        ...
                        child: RaisedButton(
                          child: Text(
                              "I'm genuinely afraid of my kitchen", style: Theme
                              .of(context)
                              .textTheme
                              .bodyText1
                  ...
                  Container(
                    ...
                    child: FractionallySizedBox(
                        ...
                        child: RaisedButton(
                          child: Text(
                              "I can freestyle in the kitchen", style: Theme
                              .of(context)
                              .textTheme
                              .bodyText1
                              .copyWith(fontSize: 18.0),
...
class SignupFrequency extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Frequency", style: Theme
              .of(context)
              .textTheme
              .headline3),
          backgroundColor: Colors.transparent,
                        ...
                        children: [
                          Expanded(
                              child: SalusSlider(
                                ...
                                max: 4,
                                ticks: 3,
                                sliderUpdate: (double sliderValue) {
                    ...
                    child: FractionallySizedBox(
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => SignupUserInformation(signup)));
                          },
                        )
                    ),
                  ),
